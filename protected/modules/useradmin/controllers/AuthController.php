	...
	public function actionRegistration() {
		...
		if (isset($_POST ['URegistrationForm'])) {
			...
			if ($model->save()) {
				...
				/*
				 * $roleCode = 'client'; // You should have role with this code $userHasUserRole = new UserHasUserRole; $userHasUserRole->user_id = $model->id; $userHasUserRole->user_role_code = $roleCode; $userHasUserRole->save(false);
				 */
