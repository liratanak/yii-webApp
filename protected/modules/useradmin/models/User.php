...
class User extends CActiveRecord {
	 ...
	 *
	 * @param mixed $role
	 *        	- can be string, or array of roles
	 * @param boolean $superAdminHasAccess
	 *        	- will return "true" if user has $role or he is superAdmin
	 *        	
	 * @return boolean
	 */
	 ...
	 * @param string $task        	
	 * @param boolean $superAdminHasAccess
	 *        	- will return "true" if user has $task or he is superAdmin
	 *        	
	 * @return boolean
	 */
	...
	public function rules() {
		return array (
				array (
						'login, password, repeat_password, is_superadmin',
						'required' 
				),
				
				array (
						'login, password, is_superadmin',
						'purgeXSS' 
				),
				...
				array (
						'id, login, password, active, is_superadmin, findByRole',
						'safe',
						'on' => 'search' 
				) 
		);
	...
	public function relations() {
		return array (
				'roles' => array (
						self::MANY_MANY,
						'UserRole',
						'user_has_user_role(user_id, user_role_code)' 
				),
				'tasks' => array (
						self::MANY_MANY,
						'UserTask',
						'user_has_user_task(user_id, user_task_code)' 
				),
				'cache' => array (
						self::HAS_ONE,
						'UserCache',
	 ...
	 * getIsSuperAdminList
	 *
	 * @param boolean $withLabelInfo
	 *        	- false for dropDownList
	 *        	
	 * @return array
	 */
