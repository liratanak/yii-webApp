...
$this->breadcrumbs = array (
		Yii::t("UserAdminModule.breadcrumbs", "Manage user roles") => array (
				'admin' 
		),
...
echo $taskForm->checkBoxList($model, 'taskIds', CHtml::listData(UserTask::model()->findAll("code != 'freeAccess'"), 'id', 'name'), array (
